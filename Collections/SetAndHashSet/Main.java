...
public class Main {
	...
	public static void main(String[] args) {
		...
		solarSystem.put(temp.getName(),
		temp); planets.add(temp);
	  
		tempMoon = new Moon("Io", 1.8); 
		solarSystem.put(tempMoon.getName(),
		tempMoon); temp.addSatellite(tempMoon); // temp is still Jupiter
	  ...
	  // temp is still Jupiter
		...
		solarSystem.put(temp.getName(), temp);
		planets.add(temp); System.out.println("Planets"); 
		...
		for ( HeavenlyBody planet : planets) { 
			...
			//System.out.println(plant.getName() + ": " + plant.getOrbintalPeriod()); }
	  
		Object o = new Object(); System.out.println(o.equals(o));
