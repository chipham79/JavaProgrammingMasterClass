...
public class Demo {
	public static void main(String[] args) {
		 ...
		 * printList(placesToVisit);
		 * 
		 * placesToVisit.add(1, "Alice Springs"); printList(placesToVisit);
		 * 
		 * placesToVisit.remove(4); printList(placesToVisit);
		 */
	}
	...
	private static boolean addInOrder(LinkedList<String> linkedList, String newCity) {
		...
		while(stringListIterator.hasNext()) {
			...
			if(comparsion == 0) {
				// equal, do not add
				System.out.println(newCity + " is already inclued as a destination");
				return false;
			}
